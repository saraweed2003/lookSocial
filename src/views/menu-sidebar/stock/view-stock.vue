...
import tableStock from "../../../components/back/stock/table-stock.vue";
      ...
      <div class="overflow-auto max-h-[60vh] custom-scrollbar">
        ...
        >
          ...
          <div class="col-span-1 flex p-[16px] text-center">
            <div class="text-[#1BBE0D] bg-green-100 p-[5px] rounded">
              กำลังใช้งาน
            </div>
            <!-- <div class="text-[#FF0000]">ใช้งานไม่ได้</div>
          <div class="text-[#FFD600]">สต็อก</div>
          <div class="text-[#DB00FF]">อื่นๆ</div> -->
          </div>
